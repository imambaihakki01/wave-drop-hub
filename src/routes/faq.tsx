...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — Orbexa Network" },
      { name: "description", content: "Frequently asked questions about Orbexa Network airdrop, eligibility, points, referrals and rewards." },
      { property: "og:title", content: "FAQ — Orbexa Network" },
      { property: "og:description", content: "Everything you need to know about the Orbexa Network airdrop." },
    ],
  }),
  component: FAQ,
});
...
const faqs = [
  { q: "What is Orbexa Network?", a: "Orbexa Network is a community-driven crypto airdrop platform. By engaging with our ecosystem and inviting friends, you earn points that translate into priority token allocation when the snapshot is taken." },
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-16 space-y-10">
      <header className="text-center animate-fade-in">
        ...
        <p className="mt-3 text-muted-foreground">Everything you need to know about Orbexa Network.</p>
      </header>
