...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — WaveDrop" },
      { name: "description", content: "Frequently asked questions about WaveDrop airdrop, eligibility, points, referrals and rewards." },
      { property: "og:title", content: "FAQ — WaveDrop" },
      { property: "og:description", content: "Everything you need to know about the WaveDrop airdrop." },
    ],
  }),
  component: FAQ,
});
...
const faqs = [
  { q: "What is WaveDrop?", a: "WaveDrop is a community-driven crypto airdrop platform. By engaging with our ecosystem and inviting friends, you earn points that translate into priority token allocation when the snapshot is taken." },
  ...
  { q: "Is there any cost or gas fee?", a: "No. WaveDrop is 100% free during the campaign phase. You only need a wallet — no on-chain transactions required to participate." },
  ...
  { q: "How will rewards be distributed?", a: "Once the snapshot is taken, eligible wallets will receive WaveDrop tokens directly to their connected address. Watch our X account for the exact distribution date." },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-8 py-16 space-y-10">
      <header className="text-center animate-fade-in">
        ...
        <p className="mt-3 text-muted-foreground">Everything you need to know about WaveDrop.</p>
      </header>
